...
const read_by_id = (request, response) => {
  ...
  pool.query('SELECT count(*) as total FROM tbl_stakeholders where is_delete=false and id=$1', [id], (error, results) => {
    ...
    var sql = 'SELECT *,nama_lengkap as nama_stackholder FROM tbl_stakeholders where is_delete=false and id=$1 ORDER BY id ASC'
